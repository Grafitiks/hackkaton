...
# Check polygon distribution between old and new polygons
...
# Check gap length distribution (consecutive days)
gaps_by_poly = []
for poly_id, group in df_test.groupby('anon_polygon_id'):
    group = group.sort_values('date').reset_index(drop=True)
    # Find consecutive synthetic gaps
...
# Check what percentage of rows with known primary_ndvi are in 2025 vs earlier years
